...
def drop_for_status(data):
    ...
    data = data[data['label'] > 5.0 * 60 * 24 * 60]
...
print(train.shape)
#features = [c for c in train.columns if c not in ['loadingOrder', 'label', 'mmin', 'mmax', 'count', 'anchor_cnt', 'direction_min', 'direction_max']]
features = ['vesselMMSI', 'TRANSPORT_TRACE_start', 'TRANSPORT_TRACE_final', 'anchor_ratio', 'anchor_cnt', 'direction_min', 'direction_max', 'direction_median']
